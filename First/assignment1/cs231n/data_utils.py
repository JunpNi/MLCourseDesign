...
def load_CIFAR10(ROOT):
  ...
  for b in range(1,6):
    ...
    #f = os.path.join(ROOT, 'gists_batch_%d' % (b, ))
  ...
  #Xte, Yte = load_CIFAR_batch(os.path.join(ROOT, 'gists_test_batch'))
